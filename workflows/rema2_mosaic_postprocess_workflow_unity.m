...
addLandMask2REMATiles('tiles', '/mnt/pgc/data/projects/earthdem/tiledef_files/rema_tile_definitions_plus_sgssi.mat')
...
batchRegisterTiles('tiles', '/mnt/pgc/data/elev/dem/setsm/REMA/mosaic/v2/from_unity/altimetryByTile/')
...
batch_boundaryAdjustApply('tiles/tileNeighborIndex_10m.mat')
...
batchMergeTileBuffer('tiles/tileNeighborIndex_10m.mat')
