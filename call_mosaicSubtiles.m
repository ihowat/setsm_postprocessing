...
if dx == 10
    ...
    mosaicSubTiles(subTileDir,2,outName,'quadrant','1_1','extent',[x0,x1,y0,y1]);
    
    outName=[subTileDir,'_1_2_2m.mat'];
    mosaicSubTiles(subTileDir,2,outName,'quadrant','1_2','extent',[x0,x1,y0,y1]);
    
    outName=[subTileDir,'_2_1_2m.mat'];
    mosaicSubTiles(subTileDir,2,outName,'quadrant','2_1','extent',[x0,x1,y0,y1]);
    
    outName=[subTileDir,'_2_2_2m.mat'];
    mosaicSubTiles(subTileDir,2,outName,'quadrant','2_2','extent',[x0,x1,y0,y1]);
