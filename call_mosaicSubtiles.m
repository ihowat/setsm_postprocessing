...
if dx == 10
    ...
    mosaicSubTiles(subTileDir,10,outName);
    
else
    
    outName=[subTileDir,'_1_1_2m.mat'];
    mosaicSubTiles(subTileDir,2,outName,'1_1');
    
    outName=[subTileDir,'_1_2_2m.mat'];
    mosaicSubTiles(subTileDir,2,outName,'1_2');
    
    outName=[subTileDir,'_2_1_2m.mat'];
    mosaicSubTiles(subTileDir,2,outName,'2_1');
    
    outName=[subTileDir,'_2_2_2m.mat'];
    mosaicSubTiles(subTileDir,2,outName,'2_2');
