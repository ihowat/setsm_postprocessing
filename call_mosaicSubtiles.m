function call_mosaicSubtiles(tileName,dx)
%tileName='48_13';
%dx=2;
...
if dx == 10
    ...
    mosaicSubTiles(subTileDir,10,outName,projstr,'extent',[x0,x1,y0,y1]);
    
else
    
    outName=[subTileDir,'_1_1_2m.mat'];
    [x0,x1,y0,y1]=getTileExtents(tileName,tileDefFile,'quadrant','1_1');
    mosaicSubTiles(subTileDir,2,outName,projstr,'quadrant','1_1','extent',[x0,x1,y0,y1]);
    
    outName=[subTileDir,'_1_2_2m.mat'];
    mosaicSubTiles(subTileDir,2,outName,projstr,'quadrant','1_2','extent',[x0,x1,y0,y1]);
    
    outName=[subTileDir,'_2_1_2m.mat'];
    mosaicSubTiles(subTileDir,2,outName,projstr,'quadrant','2_1','extent',[x0,x1,y0,y1]);
    
    outName=[subTileDir,'_2_2_2m.mat'];
    mosaicSubTiles(subTileDir,2,outName,projstr,'quadrant','2_2','extent',[x0,x1,y0,y1]);
