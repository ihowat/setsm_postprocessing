...
dbasefile = 'V:/pgc/data/scratch/claire/repos/setsm_postprocessing_pgc/arcticDEMdatabase_2m_20191125.mat'; % database file
...
% empty if none.
tileDir= '/mnt/pgc/data/elev/dem/setsm/ArcticDEM/mosaic/2m_v4_tileqc/';
