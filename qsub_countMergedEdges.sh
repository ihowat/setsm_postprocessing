...
matlab_cmd="try; addpath('/mnt/pgc/data/common/repos/setsm_postprocessing_pgc'); countMergedEdges('${tiledir}', '${resolution}'); catch e; disp(getReport(e)); exit(1); end; exit(0)"
#matlab_cmd="try; addpath('/mnt/pgc/data/scratch/erik/repos/setsm_postprocessing_pgc'); countMergedEdges('${tiledir}', '${resolution}'); catch e; disp(getReport(e)); exit(1); end; exit(0)"
