...
% lon0 = -46.8293;
% 
% [x0,y0] = polarstereo_fwd(lat0,lon0,[],[],70,-45);
% 
% 
% n = find(x0 >= xmin & x0  <= xmax & y0 >= ymin & y0 <= ymax)
% 
% a=readGeotiff(strrep(f{n(1)},'meta.txt','dem.tif'))
% 
% lake 2, center? lat: 69.2418 deg,  lon:  -47.1476 deg
% 
% 
% 
% 
