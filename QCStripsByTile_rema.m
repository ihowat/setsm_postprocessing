function [] = QCStripsByTile_rema(regionNum,varargin)
...
tilefile  = 'V:/pgc/data/scratch/claire/repos/setsm_postprocessing/PGC_Imagery_Mosaic_Tiles_Antarctic.mat'; %PGC/NGA Tile definition file, required
arcdemfile= 'V:/pgc/data/scratch/claire/repos/setsm_postprocessing/rema_tiles_v2.mat'; % lists which tiles go to which regions, required
dbasefile = 'V:/pgc/data/scratch/claire/repos/setsm_postprocessing/REMAdatabase_2m.mat'; % database file
